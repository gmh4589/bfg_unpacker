...
Global $set_Gui = GUICreate($tOpenINI, 250, 220, -1, -1)
	...
	$iEngineGroup = GUICtrlCreateGroup('Show Engine', 5, 50, 130, 120)
	...
	Global $iThemes = GUICtrlCreateCheckbox("Use Themes", 20, 170, 100)
	GUICtrlSetState(-1, $iUseThemes)
	Global $iOnLaod = GUICtrlCreateCheckbox("Load Progress", 20, 190, 100)
	...
	$iGroupByGroup = GUICtrlCreateGroup('Group by', 140, 50, 95, 60)
	Global $iNameG = GUICtrlCreateRadio("Name", 150, 65, 80)
	Global $iYearG = GUICtrlCreateRadio("Year", 150, 85, 80)
    ...
    [0xFFFFFF, 0x000000, 0xC0C0C0, 0x808080, _
     ...
     0xCCFFCC, 0x99CC00, 0x339966, 0x66CC99]
	...
	ElseIf GUICtrlRead($iThemes) = 4 Then
		...
		GUICtrlSetTip(-1, 'Select Menu Color')
	EndIf
		
	GLobal $iBTNSet1 = GUICtrlCreateButton('Out Folder', 140, 135, 100, 25)
	GLobal $iBTNSet2 = GUICtrlCreateButton('Cancel', 140, 160, 100, 25)
	GLobal $iBTNSet3 = GUICtrlCreateButton('Apply', 140, 185, 100, 25)
