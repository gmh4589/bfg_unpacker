Func Main()
	Do
		...
		If $iCursorPos[4] Then
			Switch $iCursorPos[4]
				Case $iAll_Checkbox, $iFindBTN, $iFavAdd, $iFavDel, $idButton[1] to $idButton[15]
		...
		Case $idButton[2]
			...
			EndIf
		Case $idButton[3], $iTotal7zip, $Total7zipEXE
		...
		Case $idButton[7], $iUnreal
			_Engine('_Unreal')
		Case $idButton[8], $iUnity
			_Engine('_Unity')
		Case $idButton[9], $iDTech
			_Engine('_idTech')
		Case $idButton[10], $iSource
			_Engine('_Source')
		Case $idButton[11], $iBethesda
			_Engine('_Bethesda')
		Case $idButton[12], $iCryEngine
			_Engine('_CryEngine')
		Case $idButton[15]
			ClearFolder()
		Case $iFindBTN
			...
			If @error = 1 Then ControlTreeView($hGUI, "", $idTreeView_1, "Select", $tListT & '|1980-1989|' & GUICtrlRead($iFindMenu))
			If @error = 1 Then ControlTreeView($hGUI, "", $idTreeView_1, "Select", $tListT & '|1970-1979|' & GUICtrlRead($iFindMenu))
			If @error = 1 Then ControlTreeView($hGUI, "", $idTreeView_1, "Select", $tListT & '|Unknown|' & GUICtrlRead($iFindMenu))
			If @error = 1 Then MsgBox ('', '', GUICtrlRead($iFindMenu) & ' не найден')
		Case $iFavAdd
		...
		Case $iISOCompressor1, $iISOCompressor2
			...
			_OutputMSG($iOutputWindow, $sFileName)
		Case $iCDImage
		...
		Case $iConv_10
			_ChildGUI("DDS Header Generator", 'Width|Hight|' & $Format & '|' & $Offset, "2|4|8|12|16|24|32|48|64|96|128|256|384|512|768|1024|1536|2048|3072|4096|8192;2|4|8|12|16|24|32|48|64|96|128|256|384|512|768|1024|1536|2048|3072|4096|8192;DXT1|DXT3|DXT5|DX10|BC4U|BC5U|BC4S|BC5S;0|8|16|32|64", '512|512|DXT5|0') ;TODO: Hardcode text
		Case $iConv_11
