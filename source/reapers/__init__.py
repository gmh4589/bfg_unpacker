...
from source.reapers.capcom      import mt_arc, argb, tex, re_engine
from source.reapers.cdpr        import bundle, texture_cache, w2dzip, w3speech
...
from source.reapers.archives    import (dzip, seven_zip, zip_scan, zip_archive,
                                        unace
                                        )
