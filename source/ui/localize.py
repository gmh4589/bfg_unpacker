...
convert_pillow = local["convert_pillow"]
...
yes = local["yes"]
no = local["no"]
load_bar = local["load_bar"]
compress = local["compress"]
duration = local["duration"]
test_algorythm = local["test_algorythm"]
dump_create = local["dump_create"]
filed_to_unzip = local["filed_to_unzip"]
testing = local["testing"]
fav_image_format = local["fav_image_format"]
image_action = local['image_action']
only_original = local['only_original']
only_convert = local['only_convert']
original_convert = local['original_convert']
six_files_in_fol = local['six_files_in_fol']
one_format = local['one_format']
one_param = local['one_param']
eof_data = local['eof_data']
info = local['INFO']
error_in_file = local['error_in_file']
invalid_version = local['invalid_version']
do_not_exist = local['do_not_exist']
wrong_ue4 = local['wrong_ue4']
almost_done = local['almost_done']
files_is_moving = local['files_is_moving']
is_process = local['is_process']
run_as_admin = local['run_as_admin']
could_not_delete = local['could_not_delete']
not_find_unpacker = local['not_find_unpacker']
file_type = local['file_type']
tf_selector = local['tf_selector']
hand_select = local['hand_select']
enter_value = local['enter_value']
multivol = local['multivol']
big_image_error = local['big_image_error']
oodle_version = local['oodle_version']
unsupported_ftype = local['unsupported_ftype']
offset = local['offset']
clear = local['clear']
create = local['create']
six_images = local['six_images']
delete = local['delete']
warning = local['warning']
already_6 = local['already_6']
