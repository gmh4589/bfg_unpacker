...
class ChildGuiData(Setting):
    ...
    def find_zip(self):
        child_gui.ChildUIWindow(style=self.setting["Main"]["theme"],
                                gui_name=localize.find_zip_method,
    ...
    def pb_show(self):
        ...
        while not self.all_games:
            info['text'] = f'{localize.wait}: {self.current_game}/{self.all_games}'
        ...
        while self.download:
            ...
            info['text'] = f'{localize.wait}: {int(self.current_game)}/{self.all_games}'
