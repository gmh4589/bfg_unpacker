...
class ChildGuiData:
    ...
    def ffmpeg_video(self):
        widths_heights = ['120', '144', '160', '192', '240', '256', '272', '288', '308', '320', '342', '360', '384', '400', '426', '480', '512', '540', '576', '600', '640', '720', '768', '800', '810', '854', '864', '900', '960', '1024', '1050', '1064', '1080', '1136', '1200', '1152', '1200', '1280', '1350', '1360', '1366', '1400', '1440', '1536', '1600', '1620', '1800', '1920', '2025', '2048', '2160', '2250', '2400', '2560', '2880', '3072', '3200', '3240', '3440', '3384', '3840', '4096', '4320', '4800', '5120', '5760', '6016', '6400', '7680', '8192', '8640', '10240', '10320', '15360', localize.other]
        child_gui.ChildUIWindow(gui_name='FFMPEG Video Converter',
                                label_list=['Video Codec', 'Audio Codec', 'Video Bitrate', 'Audio Bitrate', 'Format', 'Width', 'High', 'Audio Track'],
                                action_list=[['a64_multi', 'a64_multi5', 'alias_pix', 'amv', 'apng', 'asv1', 'asv2', 'avrp', 'avui', 'ayuv', 'bmp', 'cinepak', 'cljr', 'dirac', 'dnxhd', 'dpx', 'dvvideo', 'ffv1', 'ffvhuff', 'flashsv', 'flashsv2', 'flv1', 'gif', 'h261', 'h263', 'h263p', 'h264', 'hap', 'hevc', 'huffyuv', 'jpeg2000', 'jpegls', 'ljpeg', 'mjpeg', 'mpeg1video', 'mpeg2video', 'mpeg4', 'msmpeg4v2', 'msmpeg4v3', 'msvideo1', 'pam', 'pbm', 'pcx', 'pgm', 'pgmyuv', 'png', 'ppm', 'prores', 'qtrle', 'r10k', 'r210', 'rawvideo', 'roq', 'rv10', 'rv20', 'sgi', 'snow', 'sunrast', 'svq1', 'targa', 'theora', 'tiff', 'utvideo', 'v210', 'v308', 'v408', 'v410', 'vp8', 'vp9', 'webp', 'wmv1', 'wmv2', 'wrapped_avframe', 'xbm', 'xface', 'xwd', 'y41p', 'yuv4', 'zlib', 'zmbv', localize.other],
                                             ...
                                             ['64k', '128k', '192k', '256k', '512k', '768k', '1M', '2M', '3M', '4M', '5M', '6M', '8M', '10M', '12M', '15M', '16M', '20M', '25M', '30M', '40M', '50M', localize.other],
                                             ['16k', '24k', '32k', '48k', '64k', '96k', '112k', '128k', '160k', '192k', '224k', '256k', '320k', '360k', '448k', '512k', '768k', '1M', '2M', localize.other],
                                             ['3g2', '3gp', 'a64', 'asf', 'avi', 'dv', 'dvd', 'f4v', 'flv', 'hevc', 'ivf', 'm1v', 'm2v', 'm2t', 'm2ts', 'm4v', 'mkv', 'mjpeg', 'mov', 'mp4', 'mpeg', 'mpg', 'mts', 'mxf', 'ogv', 'pam', 'rm', 'roq', 'swf', 'ts', 'vc1', 'vp8', 'vob', 'webm', 'wmv', 'wtv', localize.other],
    ...
    def ffmpeg_audio(self):
        child_gui.ChildUIWindow(gui_name='FFMPEG Audio Converter',
                                label_list=['Frequency', 'Channels', 'Audio Bitrate', 'Speed', 'Codec', 'Format'],
                                action_list=[['8000', '12000', '16000', '22050', '24000', '32000', '36000', '44100', '48000', '96000', '192000', '384000', localize.other],
                                             ['1', '2', '3', '4', '5', '6', '7', '8', localize.other],
                                             ['8k', '12k', '16k', '20k', '24k', '32k', '48k', '64k', '96k', '112k', '128k', '160k', '192k', '256k', '320k', '448k', '512k', '768k', '1M', '2M', localize.other],
                                             ['1/2', '1', '2', localize.other],
                                ...
                                combos={
                                    ...
                                    'm4a':  ['alac', 'aac', 'ac3', localize.other],
                                    'ra':   ['ra_144', localize.other],
                                    'ogg':  ['libvorbis', 'opus', 'flac', localize.other],
    ...
    def ffmpeg_image(self):
        child_gui.ChildUIWindow(gui_name='FFMPEG Image Converter',
                                label_list=['Format'],
    ...
    def raw2wav(self):
        child_gui.ChildUIWindow(gui_name='RAW to WAV Converter',
    ...
    def raw2atrac(self):
        child_gui.ChildUIWindow(gui_name='RAW to Atrac Converter',
    ...
    def raw2dds(self):
        child_gui.ChildUIWindow(gui_name='DDS Header Generator',
                                label_list=['Height', 'Width', 'Format', 'Offset', 'Mip count', 'Cubemap'],
                                action_list=[['2', '4', '8', '12', '16', '24', '32', '48', '64', '96', '128', '256', '384', '512', '768', '1024', '1536', '2048', '3072', '4096', '8192', localize.other],
                                             ['2', '4', '8', '12', '16', '24', '32', '48', '64', '96', '128', '256', '384', '512', '768', '1024', '1536', '2048', '3072', '4096', '8192', localize.other],
    ...
    # def nConvert(self):
    #     child_gui.ChildUIWindow(style = style,
    #                             gui_name='nConverter',
    #                             label_list=['Format'],
    ...
    def pillow_conv(self):
        child_gui.ChildUIWindow(gui_name='Pillow Converter',
                                label_list=['Format'],
    ...
    def wwise_tools(self):
        child_gui.ChildUIWindow(gui_name='Wwise Converter',
    ...
    # TODO: Нужна ли? VGM все это умеет
    def xwm2wav(self):
        child_gui.ChildUIWindow(gui_name='XWM/WAV Converter',
